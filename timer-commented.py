# SAMOE'S COUNTDOWN TIMER
# COMMENTED VERSION
# 5/8/22

# github.com/samoe97/countdown-tk
...
# FUNCTION THAT UPDATES CURRENT TIME CLOCK THEN LOOPS
def updateTimeVar() :
...
# FLASH BETWEEN THEMES TO SIGNAL THAT THE TIMER ENDED, THIS IS PRETTY BAD TO BE HONEST
def flashWindow() :
    previousTheme = theme
